...
class SynapseFormationDataModule(LightningDataModule):
    def __init__(self, metadata, train_index, val_index, test_index, label_map, selected_channels, statistics, 
                 train_transform, val_transform, test_transform, batch_size=128, reshape_size=160):
        super().__init__()
