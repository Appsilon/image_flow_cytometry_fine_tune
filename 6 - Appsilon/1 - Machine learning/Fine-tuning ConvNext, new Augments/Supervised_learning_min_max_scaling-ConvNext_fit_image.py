...
tools.save_multichannel_preview(train_loader, n_samples=10, save_path="train_multichannel_convnext_fit_image_preview.png")
tools.save_multichannel_preview(val_loader, n_samples=10, save_path="valid_multichannel_convnext_fit_image_preview.png")
print("Preview saved!\n\n")
