...
from utils import convnext_smaller, tools
...
model = convnext_smaller.ConvnextSmalltModel(num_classes=len(set_of_interesting_classes), in_chans=len(selected_channels), steps_per_epoch=len(train_loader), learning_rate=lr, max_epochs=max_epochs)
